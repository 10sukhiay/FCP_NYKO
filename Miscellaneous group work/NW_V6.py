...
def main(*args):
    ...
    sim = simulate(people=people, heat_maps=heat_maps, position_state=position_state, xsize=args.size_x, ysize=args.size_y)
...
def simulate(people, heat_maps, position_state, xsize, ysize):
    for it in range(10):
        for i in people:
